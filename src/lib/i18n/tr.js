export default {
  ...
  settings: {
    ...
    darkMode: 'Koyu tema',
    lightMode: 'Açık tema',
    toggleThemeTitle: 'Açık/koyu temayı değiştir',
    ...
    tickingSoundLabel: 'Tik sesi',
    tickingSoundHint: "Aktif bir Pomodoro sırasında hafif bir tik sesi çalar; duraklatma, iptal veya tamamlanmada durur.",

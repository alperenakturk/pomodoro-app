export default {
  ...
  settings: {
    ...
    themeLabel: 'Tema',
    themeDark: 'Koyu',
    themeDarkEspresso: 'Koyu Espresso',
    themeDarkSlate: 'Koyu Arduvaz',
    themeLightTerracotta: 'Açık Terrakota',
    themeLightSage: 'Açık Adaçayı',
    themeLightSand: 'Açık Kum',
    themeLightDustyBlue: 'Açık Toz Mavisi',
    themeVividCoral: 'Canlı Mercan',
    themeVividCitrus: 'Canlı Turunçgil',
    themeVividMint: 'Canlı Nane',
    themeTierDark: 'Koyu',
    themeTierLightPastel: 'Açık Pastel',
    themeTierLightVivid: 'Açık Canlı',
    themeRecommendedBadge: 'Önerilen',
    themeCustom: 'Özel',
    rgbPartyModeLabel: 'RGB Modu',
    rgbPartyModeOn: 'Açık',
    rgbPartyModeOff: 'Kapalı',
    rgbPartyModeWarning: 'Hızlı, tekrarlayan renk ve parlaklık değişimleri içerir — yanıp sönen ışıklara duyarlıysanız dikkatli olun.',

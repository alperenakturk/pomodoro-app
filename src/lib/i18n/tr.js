export default {
  ...
  timer: {
    ...
    startDisabledTitle: "Başlamadan önce Planlama'da bir aktif görev seç",
    ...
    shortcutPause: 'Zamanlayıcıyı duraklat / devam ettir',
  ...
  settings: {
    ...
    replayWelcome: 'Karşılama mesajını tekrar göster',
